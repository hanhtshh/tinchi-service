...
import { asyncConnectMysqlDB } from "./common/connection/mysql";
...
class App extends EventEmitter {
  ...
  private initializeMiddlewares() {
    ...
    this.app.use(
      (request: IRequest, _response: Response, next: NextFunction) => {
   ...
   */
  private initializeSequelize(sequelize: Sequelize) {
